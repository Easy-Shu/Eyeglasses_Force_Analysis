...
Regression results of physical dataset for plastic temples. (a) plastic eyeglasses samples. (b) multiple regression result for superposed displacement d. (c) linear regression result for temple displacement d. ![](http://latex.codecogs.com/svg.latex?d=0.0316F\cdot{L^3}+0.0618F\cdot{L})
