# -*- coding: utf-8 -*-
"""
Created on Fri May 19 15:33:44 2023
...
df_data=pd.read_csv("Data_Metal_Temples.csv")

df_data["L_F"]=df_data["Temple_Length"]*df_data["Clapping_Force"]
df_data["FXL3_3_E"]=df_data["Clapping_Force"]*np.power(df_data["Temple_Length"],3)/1000/3 #207
...
+theme_matplotlib()
+theme(legend_position=(0.35,0.775),#"right",
...
gg_mapf0=(ggplot()
 ...
 +scale_fill_cmap(cmap_name="YlGnBu",name="Original\n$d$\n(mm)",breaks=range(0,12,2),limits=(0,10))
 +scale_y_continuous(minor_breaks=None,expand=(0,0))#breaks=range(10,70,10),limits=(5,60),
...
gg_mapf=(ggplot()
 +geom_tile(df_grid,aes('FXL3_3_E', 'L_F',fill='z'),color=None,size=2)
 +geom_point(df_data,aes('FXL3_3_E', 'L_F',fill='d'),size=2.5,stroke=0.25,shape="o")
